export const DE = {
    ...
    MaxAutoSellConcurrencyReached:
        "Du hast die maximale Verkaufsanzahl erreicht, breche oder schließe einen anderen Handel ab, um diesen hinzuzufügen.",
    ...
    ClearTradesTitle: "Alle Handel zurücksetzen",
    ClearTradesDescription:
        "Weder Geld, noch Ressourcen werden zurückerstattet - nutze diese Funktion nur, wenn es Probleme mit älteren Handeln gibt.",
    ClearTradesNo: "Nicht zurücksetzen",
    ClearTradesYes: "Ja, alles löschen!",
    OnlyShowPositiveModifiers: "Nur positive Zellmodifikatoren anzeigen",
    OnlyShowPositiveModifiersHint: "Aktiviere die Checkbox links, um alle Zellmodifikatoren einzublenden",
    ClearMyTradesV2: "Handel löschen",
    OpenSource: "Komm ins Team",
    OpenSourceDesc: "Industry Idle ist jetzt als Open Source verfügbar. Auf GitHub kannst du dich in die Entwicklung individuell einbringen!",
    GameGuides: "Spielanleitungen",
    GameSetting: "Einstellungen",
    GameSettingDesc: "Richte das Spiel nach deinen Vorlieben ein",
    GameSettingGeneral: "Allgemein",
    GameSettingDisplay: "Anzeige",
    GameSettingHideElements: "Element ausblenden",
    GameSettingAudio: "Audio",
    GameSettingGameplay: "Im Spiel",
    GameSettingSinglePlayerMode: "Single-Player Modus",
    GameSettingBuildWarningPowerBank: "Warnungen deaktivieren: Stromspeicher",
    GameSettingBuildWarningPowerBankDesc:
        "Deaktiviere Bauwarnungen, wenn du einen Stromspeicher abseits deiner Stromgeneratoren platzierst.",
    GameSettingBuildWarningResourceBooster: "Warnungen deaktivieren: Ressourcenverstärker",
    GameSettingBuildWarningResourceBoosterDesc:
        "Deaktiviere Bauwarnungen, wenn du einen Verstärker abseits deiner Minen platzierst.",
    GameSettingVolumeControl: "Lautstärke",
    GameSettingMusicVolume: "Musik",
    GameSettingMusicVolumeDesc: "Steuer die Lautstärke der Hintergrundmusik",
    GameSettingSFXVolume: "Effektlautstärke",
    GameSettingSFXVolumeOverride: "Effektlautstärke ändern",
    GameSettingSFXVolumeDesc: "Passe die Lautstärke der Spieleffekte an.",
    GameSettingSFXEnableOverride: "'SFX Lautstärke überschreiben' erlauben",
    GameSettingSFXClick: "Klick",
    GameSettingSFXClickDesc:
        "Lautstärkeregler für den Soundeffekt, der zu hören ist, wenn du auf verschiedene Dinge klickst.",
    GameSettingSFXCompleted: "Handel abgeschlossen",
    GameSettingSFXCompletedDesc:
        "Der Soundeffekt, der zu hören ist, wenn ein Handel auf dem Spielermarkt beanspruchbar ist.",
    GameSettingSFXFreeChest: "Offlineeinnahmen einsammeln",
    GameSettingSFXFreeChestDesc:
        "Lautstärkeregler für den Effekt, der zu hören ist, wenn Offlineeinnahmen einkassiert werden.",
    GameSettingSFXGold: "Klirrende Münzen",
    GameSettingSFXGoldDesc:
        "Lautstärkeregler für den Soundeffekt von klirrenden Münzen, der gegen Ende der Offlineeinnahmen- Animation zu hören ist.",
    GameSettingSFXError: "Fehler",
    GameSettingSFXErrorDesc:
        "Lautstärkeregler für die Fehlerbenachrichtigungen, die zu hören ist, wenn du versucht eine Aktion auszuführen, die nicht möglich ist.",
    GameSettingSFXKaching: "Ka-ching",
    GameSettingSFXKachingDesc:
        "Lautstärkeregler für den Ka-Ching Effekt, der überall im Spiel immer wieder auftaucht, meist dann, wenn Geldeinnahmen beansprucht werden.",
    GameSettingSFXLevelup: "Errungenschaft freigeschaltet",
    GameSettingSFXLevelupDesc: "Lautstärkeregler für den Soundeffekt, der zu hören ist, wenn Errungenschaften freigeschaltet werden.",
    GameSettingSFXPowerup: "Neue Großmarktbestellung",
    GameSettingSFXPowerupDesc:
        "Reguliert die Benachrichtigungslautstärke beim Eingang neuer Großmarktsaufträge.",
    GameSettingSFXBubble: "Chaterwähnung",
    GameSettingSFXBubbleDesc: "Das Geräusch, das spielt, wenn jemand dich mit '@' im Chat markiert.",
    GameSettingInput: "Eingang",
    PlayerTradesShowHistory: "Kürzliche Handel anzeigen",
    PlayerTradesHistory: "Handelsverlauf",
